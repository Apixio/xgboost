...
pipeline {
    ...
    stages {
        ...
        stage('Build & Test') {
            agent any
            steps {
              sh 'cd jvm-packages; mvn clean compile package -DaltDeploymentRepository=apixio.snapshots.build::default::https://repos.apixio.com/nexus/content/repositories/snapshots/ deploy'
            }
        }
    }
}
